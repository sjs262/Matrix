public final class Fraction implements MatrixElement {
	...
	public MatrixElement simplify() {
		...
		if (denom.imag != 0) {
			...
			newDenom = new Complex((int) denom.magSq(), 0);
		}
	...
	public MatrixElement reduce() {
		...
		if (denom.real / gcd < 0 || (denom.real / gcd == 0 && denom.imag / gcd < 0))
			gcd *= -1;
  ...
  public double magSq() {
	...
	public boolean equals(Object other) {
		if (other instanceof Fraction) {
			Fraction otherFrac = (Fraction) other;
			return numer.equals(otherFrac.numer) && denom.equals(otherFrac.denom);
		}
		return false;
	}
